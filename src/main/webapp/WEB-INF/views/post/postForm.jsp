...
<form class="form-horizontal" id="postFrm" role="form" action="${cp }/post/newPost?boardseq=${param.boardseq}" method="post" enctype="multipart/form-data">
	<div class="col-sm-12 blog-main">
		<h2 class="sub-header">${S_POSTBOARDVO.boardnm }</h2>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" id="posttitle" name="posttitle" value="${param.posttitle }">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<textarea class="form-control" name="postcont" id="smarteditor" rows="10" cols="100" style="width:766px; height:412px;">${param.postcont}</textarea>
						</div>
					</div>
