...
<form class="form-horizontal" id="replyFrm" role="form" action="${cp }/post/replyForm" method="post" enctype="multipart/form-data">
	<div class="form-group">
		<input type="hidden" class="form-control" id="rpostseq" name="postseq" value="${post.postseq }">
		<input type="hidden" class="form-control" id="gn" name="gn" value="${post.gn }">
		<input type="hidden" class="form-control" id="boardseq" name="boardseq" value="${post.boardseq }">
	</div>
